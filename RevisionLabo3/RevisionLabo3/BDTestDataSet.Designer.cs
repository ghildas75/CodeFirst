...
namespace RevisionLabo3.BDTestDataSetTableAdapters {
...
SELECT cliNo, cliPrenom, cliNom, cliRue, cliVille, cliTelephone FROM client WHERE (cliNo = @cliNo)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::RevisionLabo3.Properties.Settings.Default.BDTestConnectionString;
        }
        ...
        public virtual int Fill(BDTestDataSet.clientDataTable dataTable) {
        ...
        public virtual BDTestDataSet.clientDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BDTestDataSet.clientDataTable dataTable = new BDTestDataSet.clientDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BDTestDataSet.clientDataTable dataTable) {
    ...
    public partial class contratTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [contrat] WHERE (([conNo] = @Original_conNo) AND ((@IsNull_conDate = 1 AND [conDate] IS NULL) OR ([conDate] = @Original_conDate)) AND ((@IsNull_conAcompte = 1 AND [conAcompte] IS NULL) OR ([conAcompte] = @Original_conAcompte)) AND ((@IsNull_conMontant = 1 AND [conMontant] IS NULL) OR ([conMontant] = @Original_conMontant)) AND ((@IsNull_ConPaye = 1 AND [ConPaye] IS NULL) OR ([ConPaye] = @Original_ConPaye)) AND ((@IsNull_conTypeOcc = 1 AND [conTypeOcc] IS NULL) OR ([conTypeOcc] = @Original_conTypeOcc)) AND ((@IsNull_empNo = 1 AND [empNo] IS NULL) OR ([empNo] = @Original_empNo)) AND ((@IsNull_voyNo = 1 AND [voyNo] IS NULL) OR ([voyNo] = @Original_voyNo)) AND ((@IsNull_cliNo = 1 AND [cliNo] IS NULL) OR ([cliNo] = @Original_cliNo)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [contrat] ([conNo], [conDate], [conAcompte], [conMontant], [ConPaye], [conTypeOcc], [empNo], [voyNo], [cliNo]) VALUES (@conNo, @conDate, @conAcompte, @conMontant, @ConPaye, @conTypeOcc, @empNo, @voyNo, @cliNo);
...
SELECT conNo, conDate, conAcompte, conMontant, ConPaye, conTypeOcc, empNo, voyNo, cliNo FROM contrat WHERE (conNo = @conNo)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(BDTestDataSet.contratDataTable dataTable, global::System.Nullable<decimal> empNo) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual BDTestDataSet.contratDataTable GetData(global::System.Nullable<decimal> empNo) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((empNo.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(empNo.Value));
            }
...
SELECT empNo, empPrenom, empNom, empEmploi, empSal, empComm, empSup, empBureau FROM employe WHERE (empNo = @empNo)";
    ...
    public partial class faitLeVoyageTableAdapter : global::System.ComponentModel.Component {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(BDTestDataSet.faitLeVoyageDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual BDTestDataSet.faitLeVoyageDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BDTestDataSet.faitLeVoyageDataTable dataTable = new BDTestDataSet.faitLeVoyageDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BDTestDataSet.faitLeVoyageDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
...
SELECT hotNo, hotNom, hotCote, hotPiscine, hotNbChambreTot FROM hotel WHERE (hotNo = @hotNo)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(BDTestDataSet.hotelDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual BDTestDataSet.hotelDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BDTestDataSet.hotelDataTable dataTable = new BDTestDataSet.hotelDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BDTestDataSet.hotelDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
...
SELECT voyNo, voyDestination, voyDateDepart, voyDateArrive, voyRepas, voyNbPlace, voyActivite, empNo, hotno, tarifSimple, tarifDouble, tarifTriple, tarifQuadruple, NbChambreRes FROM voyage WHERE (voyNo = @voyNo)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(BDTestDataSet.voyageDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual BDTestDataSet.voyageDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BDTestDataSet.voyageDataTable dataTable = new BDTestDataSet.voyageDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BDTestDataSet.voyageDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
